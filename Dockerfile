...
LABEL io.github.snakemake.conda_env_hash="ed8baa51086c556ff7709f482151a47b7a62add9a948fee73f8187bf29ce5662"
...
# Conda environment:
#   source: workflow/envs/bedtools.yml
#   prefix: /conda-envs/358865313c58e8136880640ff9d908f5
#   name: bedtools
#   channels:
#     - conda-forge
#   dependencies:
...
# Conda environment:
#   source: workflow/envs/braker4.yml
#   prefix: /conda-envs/4be7528d878e9cf217f9cc55aa6a835b
#   name: braker4
#   channels:
#     - conda-forge
#     - bioconda
#   dependencies:
#     - python=3.12
#     - snakemake-minimal=9.8.0
#     - pandas=2.2.3
RUN mkdir -p /conda-envs/4be7528d878e9cf217f9cc55aa6a835b
COPY workflow/envs/braker4.yml /conda-envs/4be7528d878e9cf217f9cc55aa6a835b/environment.yaml
...
#   prefix: /conda-envs/9f3c34adf9daf46d5f50639c53e09fbc
#   name: fcs
#   channels:
#     - conda-forge
#   dependencies:
#     - python=3.13.7
#     - wget
RUN mkdir -p /conda-envs/9f3c34adf9daf46d5f50639c53e09fbc
COPY workflow/envs/fcs.yml /conda-envs/9f3c34adf9daf46d5f50639c53e09fbc/environment.yaml

# Conda environment:
#   source: workflow/envs/gbdraw.yml
#   prefix: /conda-envs/9d4284cad96d67f2f11862eece0ce4b2
#   name: gbdraw
#   channels:
#     - conda-forge
#   dependencies:
#     - bioconda::gbdraw=0.11.0
#     - conda-forge::biopython=1.87
RUN mkdir -p /conda-envs/9d4284cad96d67f2f11862eece0ce4b2
COPY workflow/envs/gbdraw.yml /conda-envs/9d4284cad96d67f2f11862eece0ce4b2/environment.yaml
...
# Conda environment:
#   source: workflow/envs/gffread.yml
#   prefix: /conda-envs/12d8afcd573a7d227f3036f560fac5db
#   name: gffread
#   channels:
#     - conda-forge
#   dependencies:
#     - bioconda::gffread=0.12.7
RUN mkdir -p /conda-envs/12d8afcd573a7d227f3036f560fac5db
COPY workflow/envs/gffread.yml /conda-envs/12d8afcd573a7d227f3036f560fac5db/environment.yaml
...
# Conda environment:
#   source: workflow/envs/longstitch.yml
#   prefix: /conda-envs/040908e3c100580785546fe7d5b74b3d
#   name: longstitch
#   channels:
#     - conda-forge
#   dependencies:
#     - bioconda::longstitch=1.0.5
RUN mkdir -p /conda-envs/040908e3c100580785546fe7d5b74b3d
COPY workflow/envs/longstitch.yml /conda-envs/040908e3c100580785546fe7d5b74b3d/environment.yaml
...
# Conda environment:
#   source: workflow/envs/minimap2.yml
#   prefix: /conda-envs/25a8e15d54aed664de8363431222d86c
#   name: minimap2
#   channels:
#     - conda-forge
#   dependencies:
...
RUN mkdir -p /conda-envs/25a8e15d54aed664de8363431222d86c
COPY workflow/envs/minimap2.yml /conda-envs/25a8e15d54aed664de8363431222d86c/environment.yaml
...
# Conda environment:
#   source: workflow/envs/organelle_rna_editing.yml
#   prefix: /conda-envs/fb6ecba479117c702a8b1957392a2977
#   name: organelle_rna_editing
#   channels:
#     - conda-forge
#   dependencies:
#     - python=3.12
...
RUN mkdir -p /conda-envs/fb6ecba479117c702a8b1957392a2977
COPY workflow/envs/organelle_rna_editing.yml /conda-envs/fb6ecba479117c702a8b1957392a2977/environment.yaml

# Conda environment:
#   source: workflow/envs/pga_v2.yml
#   prefix: /conda-envs/c4ae04d69c85f9a6d72f072f28df8997
#   name: pga_v2
#   channels:
#     - conda-forge
#   dependencies:
...
#     - bioconda::minimap2=2.30
RUN mkdir -p /conda-envs/c4ae04d69c85f9a6d72f072f28df8997
COPY workflow/envs/pga_v2.yml /conda-envs/c4ae04d69c85f9a6d72f072f28df8997/environment.yaml

# Conda environment:
#   source: workflow/envs/pybase.yml
#   prefix: /conda-envs/c48213978d6b303358e6775011b2b663
#   name: pybase
#   channels:
#     - conda-forge
#   dependencies:
...
#     - numpy=2.2.6
#     - biopython=1.87
RUN mkdir -p /conda-envs/c48213978d6b303358e6775011b2b663
COPY workflow/envs/pybase.yml /conda-envs/c48213978d6b303358e6775011b2b663/environment.yaml

# Conda environment:
#   source: workflow/envs/pycirclize.yml
#   prefix: /conda-envs/9054477bf5f407be79e52f91bfe426fc
#   name: pycirclize
#   channels:
#     - conda-forge
#   dependencies:
#     - conda-forge::pycirclize=1.10.1
#     - conda-forge::biopython=1.87
RUN mkdir -p /conda-envs/9054477bf5f407be79e52f91bfe426fc
COPY workflow/envs/pycirclize.yml /conda-envs/9054477bf5f407be79e52f91bfe426fc/environment.yaml
...
RUN conda env create --prefix /conda-envs/a7401219cb36035d7c6438fc301a8525 --file /conda-envs/a7401219cb36035d7c6438fc301a8525/environment.yaml && \
    ...
    conda env create --prefix /conda-envs/4be7528d878e9cf217f9cc55aa6a835b --file /conda-envs/4be7528d878e9cf217f9cc55aa6a835b/environment.yaml && \
    ...
    conda env create --prefix /conda-envs/9f3c34adf9daf46d5f50639c53e09fbc --file /conda-envs/9f3c34adf9daf46d5f50639c53e09fbc/environment.yaml && \
    conda env create --prefix /conda-envs/9d4284cad96d67f2f11862eece0ce4b2 --file /conda-envs/9d4284cad96d67f2f11862eece0ce4b2/environment.yaml && \
    ...
    conda env create --prefix /conda-envs/12d8afcd573a7d227f3036f560fac5db --file /conda-envs/12d8afcd573a7d227f3036f560fac5db/environment.yaml && \
    ...
    conda env create --prefix /conda-envs/040908e3c100580785546fe7d5b74b3d --file /conda-envs/040908e3c100580785546fe7d5b74b3d/environment.yaml && \
    ...
    conda env create --prefix /conda-envs/25a8e15d54aed664de8363431222d86c --file /conda-envs/25a8e15d54aed664de8363431222d86c/environment.yaml && \
    ...
    conda env create --prefix /conda-envs/fb6ecba479117c702a8b1957392a2977 --file /conda-envs/fb6ecba479117c702a8b1957392a2977/environment.yaml && \
    conda env create --prefix /conda-envs/c4ae04d69c85f9a6d72f072f28df8997 --file /conda-envs/c4ae04d69c85f9a6d72f072f28df8997/environment.yaml && \
    conda env create --prefix /conda-envs/c48213978d6b303358e6775011b2b663 --file /conda-envs/c48213978d6b303358e6775011b2b663/environment.yaml && \
    conda env create --prefix /conda-envs/9054477bf5f407be79e52f91bfe426fc --file /conda-envs/9054477bf5f407be79e52f91bfe426fc/environment.yaml && \
