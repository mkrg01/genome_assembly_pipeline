...
def format_post_curation_record(post_curation, annotation_path: Path | None = None):
    if annotation_path is None:
        manual_note_line = (
            ...
            "annotation by hand after the workflow finishes, record those edits below."
        )
    else:
        manual_note_line = (
            "This file is regenerated by the workflow. If you edit "
            f"`{annotation_path.name}` by hand after the workflow finishes, "
            "record those edits below."
        )
